...
const CVSelection = ({ selectedComponent, handleClick }) => {
  return (
    ...
    <div>
      <div className="cv-selection-text">Choose the layout you'd like for your CV!</div>
      <div className="cv-selection-page">
        <div className="sample-one-cv-comp">
          ...
          <button className="light-version-cv-button" onClick={()=>handleClick("Version 1")}>
            Version 1
          </button>
        </div>
        ...
        <div className="sample-two-cv-comp">
          ...
          <button className="light-version-cv-button" onClick={()=>handleClick("Version 2")}>
            Version 2
          </button>
        </div>
